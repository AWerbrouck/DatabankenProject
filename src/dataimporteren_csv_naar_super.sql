...
FROM '/home/maxim/Documents/Informatica/Bachelor_1/Semester_1/Databases/Project/DatabankenProject/data/activiteitreservaties.csv'
DELIMITER ';'
CSV HEADER;
...
FROM '/home/maxim/Documents/Informatica/Bachelor_1/Semester_1/Databases/Project/DatabankenProject/data/hotelboekingen.csv'
DELIMITER ';'
CSV HEADER;

COPY super_kortingen(activiteitnaam, activiteit_postcode, hotelid, percentage_korting)
FROM '/home/maxim/Documents/Informatica/Bachelor_1/Semester_1/Databases/Project/DatabankenProject/data/kortingen.csv'
DELIMITER ';'
CSV HEADER; 
